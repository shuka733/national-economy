...
**📦 リポジトリ**: [https://github.com/shuka733/national-economy](https://github.com/shuka733/national-economy)
...
- **9ラウンドの密度**: 全9ラウンドのコンパクトな構成の中に、序盤のエンジン構築・中盤の拡大・終盤のVP追い込みが凝縮されています。
...
Glory拡張を選択すると、基本セットに加えて**71枚の新カード**（約25種類）が追加されます。

### 主な新要素

| 要素 | 説明 |
|------|------|
| **VPトークン** | 一部の建物使用時に獲得。ゲーム終了時にVPに加算 |
| **コスト0カード** | 遺物（VPトークン獲得）など、コスト0で建設可能なカード |
| **コスト6カード** | 温室、機関車工場など、高コスト高性能のカード |
| **ワーカー2体要求** | 一部のGlory建物は起動に2体のワーカーが必要 |
| **機械人形** | ロボットワーカー（+1体の追加ワーカーを獲得） |
| **可変コスト** | VPトークンの所持数に応じて建設コストが変動するカード |
| **新ボーナス建物** | 消費者組合、ギルドホール、技術博覧会など多彩な終了時ボーナス |
...
| 遺物            | 0     | 0   | VPトークン2枚獲得 |
| 養鶏場          | 0     | 4   | 消費財2〜3枚引く |
| 工房            | 1     | 8   | 建物カード1枚+VPトークン1枚 |
| 蒸気工場        | 2     | 14  | 手札2枚捨て→4枚引く |
| ゲームカフェ    | 2     | 10  | 家計から$5〜$10 |
| 記念碑          | 3     | 24  | 効果なし（高VP、🔒） |
| 消費者組合      | 3     | 18  | ボーナス: 農園VP合計20以上で+18VP |
| 劇場            | 4     | 20  | 手札2枚捨て→家計から$20 |
| 転送装置        | 5     | 22  | 手札のカードを**無料**で建設 |
| 機械人形        | 5     | 12  | ロボットワーカー1体を永久獲得 |
| 温室            | 6     | 18  | 消費財4枚引く（ワーカー2体要求） |
| 機関車工場      | 6     | 24  | 手札3枚捨て→7枚引く（ワーカー2体要求） |
